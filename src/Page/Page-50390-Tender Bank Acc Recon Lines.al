page 50390 "Tender Bank Acc Recon Lines"
{
    AutoSplitKey = true;
    ...
    var
        //  BankAccReconApplyEntries: Codeunit "Match Bank Rec. Lines"; //PCPL/NSW/07 New Codeunit add as BC suggest
        BankAccReconApplyEntries: Codeunit "Bank Acc. Recon. Apply Entries";//Original Code Comment due to Codeunit will remove Infuture
    begin
