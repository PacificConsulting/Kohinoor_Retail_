page 50393 "Delivery Order for Warehoue"
{
    ApplicationArea = All;
    ...
    Editable = false;
    PageType = List;
    QueryCategory = 'Confirm for delivery order';
...
#pragma warning restore
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                actionref("AutofillQuantity."; AutofillQuantity)
                {
                }
                // actionref("Create Inventor&y Put-away/Pick_Promoted"; Rec."Create Inventor&y Put-away/Pick")
                // {
                // }
            }
    ...
    begin
        ...
        SR.Get();
        Rec.FilterGroup(2);
        Rec.SetFilter("Location Code", SR."Default Warehouse");
        Rec.FilterGroup(0);
